        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    DoAnWebBanCayOnline.Common.Common.SendMail("TreeGarden Shop", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    DoAnWebBanCayOnline.Common.Common.SendMail("TreeGarden Shop", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
